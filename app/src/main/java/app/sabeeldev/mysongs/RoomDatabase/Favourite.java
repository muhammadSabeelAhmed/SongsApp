...
public class Favourite {
    ...
    public Favourite(@NonNull String albumID, @NonNull String albumName, @NonNull String albumsort, @NonNull String songID, @NonNull String title, @NonNull String webview, @NonNull String isRedirection, @NonNull String redirectionApp, @NonNull String image, @NonNull String youtubecode, @NonNull String songSortorder) {
